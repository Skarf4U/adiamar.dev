<div align="center">
    <a href="https://adiamar.dev"><h1 align="center">adiamar.dev</h1></a>

My personal website, built with [Next.js](https://nextjs.org/), [Tailwind CSS](https://tailwindcss.com/), [Upstash](https://upstash.com?ref=adiamar.dev), [Contentlayer](https://www.contentlayer.dev/) and deployed to [Vercel](https://vercel.com/).
...
```sh-session
git clone https://github.com/Skarf4U/adiamer.dev.git
cd adiamer.dev
```


Create a `.env` file similar to [`.env.example`](https://github.com/Skarf4U/adiamar.dev/blob/main/.env.example).
